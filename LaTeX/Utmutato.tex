...
FONTOS! A keypoints lista létrehozása után csak azokat a kulcspontokat szabad megtartani, amelyekhez $0$-nál nagyobb depth érték tartozik.
...
Ezt követően alkalmazzuk az aránypár alapú szűrést. Egy képjellemzőt akkor érdemes megtartani, ha a legközelebbi és a második legközelebbi szomszédok távolságának aránya egy bizonyos küszöbértéknél kisebb. A mérésben próbálják ki a $0.1$ an $0.7$ és a $0.9$ küszöbértékeket.

Egy párosítás távolságának lekérdezése
...
Egy darab transzformáció jelölt készítése. A bemeneti változókat a teljes listákból az előbb előállított random indexek alapján kell kiválasztani.
