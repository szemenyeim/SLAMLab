...
\begin{itemize}
	...
	\item \emph{mtx}: Egy $3\times 4$ mátrix, amely egy euklideszi transzformáció
\end{itemize}
...
A \emph{main.py} fájlban definiált \emph{useCam} változó átállításával saját felvételeket is készíthet a számítógéphez kapcsolódó RGB-D kamera segítségével. Az ENTER gomb lenyomásával képet készíthet, az ESC gomb segítségével pedig jelezheti a program felé, hogy már nem kíván több képet készíteni, így elindulhat a rekonstrukciós eljárás. Vizsgáljon meg ennek segítségével néhány saját rekonstrukciót is!
\fi
